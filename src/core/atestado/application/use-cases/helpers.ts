...
import type { AcaoAtestado } from "../../domain/autorizacao";
import { assertPode } from "../../domain/autorizacao";

/**
 * Resolve o profissional da sessão na clínica (mesmo padrão da 006).
 * `profissionalId` do atestado vem deste solicitante — nunca do input do cliente.
 */
